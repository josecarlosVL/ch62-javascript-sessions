console.log("Hello World js01 data-types");
/* ================================================================
...
const userName = "JCVL";
const userAge = "24";
const userNationality = "Mexican";

console.log(`My username is ${userName}, I am ${userAge} years old and I am ${userNationality}`);
